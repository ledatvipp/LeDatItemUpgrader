...
Version bàn giao: `0.4.0-phase04`.
...
**Không đánh dấu Phase 0–4 production-complete khi Paper/Platform module chưa build/test thật.** Core các phase được tiếp tục theo yêu cầu user trong khi chờ API artifact; không mở transaction để vượt qua gate.
